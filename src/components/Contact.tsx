...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={ref} className="relative py-32 sm:py-40 bg-black">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        >
          <div className="flex flex-wrap items-center justify-center gap-4">
            <a
              href="https://linkedin.com/in/ads-hyunwookim"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-white text-black font-semibold text-sm hover:bg-white/90 transition-all duration-300 hover:scale-105"
            >
            ...
            <a
              href="mailto:hwinside@gmail.com"
              className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-white text-black font-semibold text-sm hover:bg-white/90 transition-all duration-300 hover:scale-105"
            >
      ...
      {/* Footer */}
      <div className="mt-32 border-t border-white/[0.06] pt-8">
        <div className="max-w-4xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-white/20">
            &copy; {new Date().getFullYear()} Hyunwoo Kim
          </p>
          <p className="text-sm text-white/20">
